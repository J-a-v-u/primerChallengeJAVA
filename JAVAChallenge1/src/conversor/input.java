...
public class input {
	...
	public void convertirPesosADolares() {
			...
			//JOptionPane.showMessageDialog(null, "La cantidad "+ cantidad +" en pesos equivale a " + cantidad/203 + " en dólares.");
			
			String[] options = {"Desea realizar otra conversión?", "Salir", "Cancelar"};
			int seleccion = JOptionPane.showOptionDialog(null, "La cantidad "+ cantidad +" en pesos equivale a " + cantidad/203 + " en dólares.", null, JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
			if(seleccion == 0) {
